 ...
 */
class getApp_Repository_GedmoService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'app.repository.gedmo' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.gedmo'])) {
            return $container->services['app.repository.gedmo'];
        }

        return $container->services['app.repository.gedmo'] = $a->getRepository('App\\Entity\\GedmoExtendedExample');
    }
}
