 ...
 */
class getApp_Repository_ComicBookService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'app.repository.comic_book' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.comic_book'])) {
            return $container->services['app.repository.comic_book'];
        }

        return $container->services['app.repository.comic_book'] = $a->getRepository('App\\Entity\\ComicBook');
    }
}
