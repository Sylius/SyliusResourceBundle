 ...
 */
class getApp_Repository_BookTranslationService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'app.repository.book_translation' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.book_translation'])) {
            return $container->services['app.repository.book_translation'];
        }

        return $container->services['app.repository.book_translation'] = $a->getRepository('App\\Entity\\BookTranslation');
    }
}
