 ...
 */
class getApp_Repository_ScienceBookService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'app.repository.science_book' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.science_book'])) {
            return $container->services['app.repository.science_book'];
        }

        return $container->services['app.repository.science_book'] = $a->getRepository('App\\Entity\\ScienceBook');
    }
}
