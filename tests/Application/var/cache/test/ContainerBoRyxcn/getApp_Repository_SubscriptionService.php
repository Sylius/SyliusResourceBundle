 ...
 */
class getApp_Repository_SubscriptionService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.subscription'])) {
            return $container->services['app.repository.subscription'];
        }

        return $container->services['app.repository.subscription'] = $a->getRepository('App\\Subscription\\Entity\\Subscription');
    }
}
