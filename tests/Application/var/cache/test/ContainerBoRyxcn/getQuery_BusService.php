...
class getQuery_BusService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['query.bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 4 => ($container->privates['query.bus.middleware.send_message'] ?? $container->load('getQuery_Bus_Middleware_SendMessageService'));
            yield 5 => ($container->privates['query.bus.middleware.handle_message'] ?? $container->load('getQuery_Bus_Middleware_HandleMessageService'));
        }, 6));
    }
}
