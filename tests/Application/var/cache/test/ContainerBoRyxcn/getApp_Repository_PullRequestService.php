 ...
 */
class getApp_Repository_PullRequestService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'app.repository.pull_request' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['app.repository.pull_request'])) {
            return $container->services['app.repository.pull_request'];
        }

        return $container->services['app.repository.pull_request'] = $a->getRepository('App\\Entity\\PullRequest');
    }
}
