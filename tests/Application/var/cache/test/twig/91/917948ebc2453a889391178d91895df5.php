...
class __TwigTemplate_571d29d19611137c4cac490f423a8e07 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_previous_page_message($context, array $blocks = [])
    {
        ...
        // line 4
        $macros["__internal_parse_20"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/default.html.twig", 4)->unwrap();
        // line 5
        echo twig_call_macro($macros["__internal_parse_20"], "macro_resolve_previous_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 5, $this->source); })())], 5, $context, $this->getSourceContext());
    ...
    public function block_next_page_message($context, array $blocks = [])
    {
        ...
        // line 9
        $macros["__internal_parse_21"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/default.html.twig", 9)->unwrap();
        // line 10
        echo twig_call_macro($macros["__internal_parse_21"], "macro_resolve_next_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 10, $this->source); })())], 10, $context, $this->getSourceContext());
...
", "@BabDevPagerfanta/default.html.twig", "/home/loic/www/sylius/SyliusResourceBundle/vendor/babdev/pagerfanta-bundle/templates/default.html.twig");
    }
}
