...
class __TwigTemplate_51a108312f03c0dc89981b8918815e3e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_previous_page_message($context, array $blocks = [])
    {
        ...
        // line 4
        $macros["__internal_parse_18"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/twitter_bootstrap4.html.twig", 4)->unwrap();
        // line 5
        echo twig_call_macro($macros["__internal_parse_18"], "macro_resolve_previous_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 5, $this->source); })())], 5, $context, $this->getSourceContext());
    ...
    public function block_next_page_message($context, array $blocks = [])
    {
        ...
        // line 9
        $macros["__internal_parse_19"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/twitter_bootstrap4.html.twig", 9)->unwrap();
        // line 10
        echo twig_call_macro($macros["__internal_parse_19"], "macro_resolve_next_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 10, $this->source); })())], 10, $context, $this->getSourceContext());
...
", "@BabDevPagerfanta/twitter_bootstrap4.html.twig", "/home/loic/www/sylius/SyliusResourceBundle/vendor/babdev/pagerfanta-bundle/templates/twitter_bootstrap4.html.twig");
    }
}
