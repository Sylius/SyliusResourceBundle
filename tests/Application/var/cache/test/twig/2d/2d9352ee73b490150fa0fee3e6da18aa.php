...
/* grid/action/update.html.twig */
class __TwigTemplate_e3ded0def597879fc17f73c2117dbbad extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "grid/action/update.html.twig";
    }
    ...
    {
        return new Source("{% set path = options.link.url|default(path(options.link.route|default(grid.requestConfiguration.getRouteName('update')), options.link.parameters|default({'id': data.id}))) %}

<a href=\"{{ path }}\">Edit</a>
", "grid/action/update.html.twig", "/home/loic/www/sylius/SyliusResourceBundle/tests/Application/templates/grid/action/update.html.twig");
    }
}
