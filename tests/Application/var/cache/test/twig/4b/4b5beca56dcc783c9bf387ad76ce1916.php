...
/* grid/action/delete.html.twig */
class __TwigTemplate_c02e9bfd0b9638795d961cb7ad8beaa3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "grid/action/delete.html.twig";
    }
    ...
    {
        return array (  53 => 8,  45 => 3,  42 => 2,  40 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% set path = options.link.url|default(path(options.link.route|default(grid.requestConfiguration.getRouteName('delete')), options.link.parameters|default({'id': data.id}))) %}
...
", "grid/action/delete.html.twig", "/home/loic/www/sylius/SyliusResourceBundle/tests/Application/templates/grid/action/delete.html.twig");
    }
}
