...
/* grid/action/show.html.twig */
class __TwigTemplate_80fe3b89613a9ee9ae6af82ffbf3e89b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "grid/action/show.html.twig";
    }
    ...
    {
        return new Source("{% set path = options.link.url|default(path(options.link.route|default(grid.requestConfiguration.getRouteName('show')), options.link.parameters|default({'id': data.id}))) %}

<a href=\"{{ path }}\">Show</a>
", "grid/action/show.html.twig", "/home/loic/www/sylius/SyliusResourceBundle/tests/Application/templates/grid/action/show.html.twig");
    }
}
