...
final class FlashHelperTest extends TestCase
{
    ...
    function testImplementsFlashHelperInterface(): void
    {
        $this->assertInstanceOf(FlashHelperInterface::class, $this->flashHelper);
    }

    function testAddsResourceMessageByDefault(): void
    {
    ...
    function testAddsResourceMessageWhenCatalogueIsUnavailableAndGivenMessageCannotBeTranslated(): void
    {
        /** @var FlashBagInterface|MockObject $flashBagMock */
        $flashBagMock = $this->createMock(FlashBagInterface::class);
        /** @var MetadataInterface|MockObject $metadataMock */
    ...
    function testAddsResourceMessageWhenCatalogueIsUnavailableAndGivenMessageCanBeTranslated(): void
    {
        /** @var FlashBagInterface|MockObject $flashBagMock */
        $flashBagMock = $this->createMock(FlashBagInterface::class);
        /** @var MetadataInterface|MockObject $metadataMock */
    ...
    function testAddsResourceMessageIfMessageWasNotFoundInTheCatalogue(): void
    {
        /** @var MessageCatalogueInterface|MockObject $messageCatalogueMock */
        $messageCatalogueMock = $this->createMock(MessageCatalogueInterface::class);
        /** @var FlashBagInterface|MockObject $flashBagMock */
    ...
    function testAddsOverwrittenMessage(): void
    {
        /** @var MessageCatalogueInterface|MockObject $messageCatalogueMock */
        $messageCatalogueMock = $this->createMock(MessageCatalogueInterface::class);
        /** @var FlashBagInterface|MockObject $flashBagMock */
    ...
    function testAddsCustomMessage(): void
    {
        /** @var MessageCatalogueInterface|MockObject $messageCatalogueMock */
        $messageCatalogueMock = $this->createMock(MessageCatalogueInterface::class);
        /** @var FlashBagInterface|MockObject $flashBagMock */
    ...
    function testAddsMessageFromEvent(): void
    {
        /** @var FlashBagInterface|MockObject $flashBagMock */
        $flashBagMock = $this->createMock(FlashBagInterface::class);
        /** @var RequestConfiguration|MockObject $requestConfigurationMock */
