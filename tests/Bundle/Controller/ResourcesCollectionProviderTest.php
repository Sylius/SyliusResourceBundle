...
final class ResourcesCollectionProviderTest extends TestCase
{
    ...
    function testImplementsResourcesCollectionProviderInterface(): void
    {
        $this->assertInstanceOf(ResourcesCollectionProviderInterface::class, $this->resourcesCollectionProvider);
    }

    function testReturnsResourcesResolvedFromRepository(): void
    {
    ...
    function testHandlesPagerfanta(): void
    {
        /** @var RequestConfiguration|MockObject $requestConfigurationMock */
        $requestConfigurationMock = $this->createMock(RequestConfiguration::class);
        /** @var RepositoryInterface|MockObject $repositoryMock */
    ...
    function testRestrictsMaxPaginationLimitBasedOnGridConfiguration(): void
    {
        /** @var RequestConfiguration|MockObject $requestConfigurationMock */
        $requestConfigurationMock = $this->createMock(RequestConfiguration::class);
        /** @var RepositoryInterface|MockObject $repositoryMock */
        ...
        $this->assertEquals(1, $requestMock->query->get('page'));        $paginatorMock->expects($this->once())->method('setMaxPerPage')->with(99);
    ...
    function testCreatesAPaginatedRepresentationForPagerfantaForNonHtmlRequests(): void
    {
        /** @var RepositoryInterface|MockObject $repositoryMock */
        $repositoryMock = $this->createMock(RepositoryInterface::class);
    ...
    function testHandlesResourceGridView(): void
    {
        /** @var RequestConfiguration|MockObject $requestConfigurationMock */
        $requestConfigurationMock = $this->createMock(RequestConfiguration::class);
        /** @var RepositoryInterface|MockObject $repositoryMock */
