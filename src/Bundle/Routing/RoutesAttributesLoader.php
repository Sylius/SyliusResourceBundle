...
final class RoutesAttributesLoader implements RouteLoaderInterface
{
    public function __construct(
        ...
        private OperationAttributesRouteFactoryInterface $operationAttributesRouteFactory,
    ) {
    }
    ...
    public function __invoke(): RouteCollection
    {
        ...
        foreach (ClassReflection::getResourcesByPaths($paths) as $className) {
            ...
            $this->operationAttributesRouteFactory->createRouteForClass($routeCollection, $className);
        }
