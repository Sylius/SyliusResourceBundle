...
final class BoardGameUiTest extends ApiTestCase
{
    ...
    public function it_allows_showing_a_board_game(): void
    {
        ...
        $this->client->request('GET', '/board-games/' . $boardGames['ticket_to_ride']->id());
    ...
    public function it_allows_browsing_board_games(): void
    {
        ...
        $this->client->request('GET', '/board-games');
        $response = $this->client->getResponse();
        ...
        $this->assertStringContainsString(sprintf('<a href="/board-games/%s">Show</a>', $boardGames['stone_age']->id()), $content);
        $this->assertStringContainsString(sprintf('<a href="/board-games/%s/edit">Edit</a>', $boardGames['stone_age']->id()), $content);
        $this->assertStringContainsString(sprintf('<form action="/board-games/%s" method="post">', $boardGames['stone_age']->id()), $content);

        $this->assertStringContainsString('<td>Ticket to Ride</td>', $content);
        $this->assertStringContainsString(sprintf('<a href="/board-games/%s">Show</a>', $boardGames['ticket_to_ride']->id()), $content);
        $this->assertStringContainsString(sprintf('<a href="/board-games/%s/edit">Edit</a>', $boardGames['ticket_to_ride']->id()), $content);
        $this->assertStringContainsString(sprintf('<form action="/board-games/%s" method="post">', $boardGames['ticket_to_ride']->id()), $content);
    }
    ...
    public function it_allows_creating_a_board_game(): void
    {
        ...
        $this->client->request('GET', '/board-games/new');
    ...
    public function it_allows_updating_a_board_game(): void
    {
        ...
        $this->client->request('GET', '/board-games/' . $boardGames['stone_age']->id() . '/edit');
    ...
    {
        $this->loadFixturesFromFile('single_board_games.yml');
