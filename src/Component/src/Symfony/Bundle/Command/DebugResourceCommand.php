...
namespace Sylius\Resource\Symfony\Bundle\Command;
...
class_alias(DebugResourceCommand::class, \Sylius\Bundle\ResourceBundle\Command\DebugResourceCommand::class);
