...
use Sylius\Resource\Metadata\Resource\Factory\AttributesResourceNameCollectionFactory;
use Sylius\Resource\Tests\Dummy\DummyResource;
use Sylius\Resource\Tests\Dummy\PullRequest;

final class AttributesResourceNameCollectionFactoryTest extends TestCase
{
    public function testCreateWithInstanceOfApiResource(): void
    {
        $attributesResourceNameCollectionFactory = new AttributesResourceNameCollectionFactory(
